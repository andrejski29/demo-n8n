...
if (typeof items !== 'undefined' && Array.isArray(items)) {
    try {
        // Consolidate all items into one array of data objects
        // We assume 'items' contains all the data parts for a SINGLE match (e.g. 5 items from Merge Append)
        // We extract the .json part from each item to pass to the analyzer
